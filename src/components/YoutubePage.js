...
const YoutubePage = () => {
    ...
    const getYoutubeCards = () => {
        ...
        if (window.location.href == 'http://localhost:3000/youtube') {
        ...
        } else if (window.location.href == 'http://localhost:3000/youtube/vods') {
        ...
        } else if (window.location.href == 'http://localhost:3000/youtube/highlights') {
